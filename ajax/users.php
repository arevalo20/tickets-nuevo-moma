...
if ($action == 'ajax') {
  ...
  $aColumns = array('name', 'email', 'username'); //Columnas de busqueda
  $sTable = "user";
  $sWhere = "";
  if ($_GET['q'] != "") {
    $sWhere = "WHERE (";
  ...
  $offset = ($page - 1) * $per_page; //Count the total number of row in your table*/
    ...
    <table class="table table-striped table-hover">
      ...
      <tbody>
        ...
        ?>
          ...
          <input type="hidden" value="<?php echo $tipouser; ?>" id="tipouser<?php echo $id; ?>">
